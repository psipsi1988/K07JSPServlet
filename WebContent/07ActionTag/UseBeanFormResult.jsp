...
<body>
	<h2>useMean 액션태그로 폼의 하위요소값 받기</h2>
	...
	<h3>액션태그로 폼값 받기</h3>
	<!-- 
	useBean을 통해 객체 생성시 scope속성이 없으면 가장 좁은 page영역에 저장된다. 
	액션태그로 자바빈을 생성한 후 전송된 폼값을 한 번에 설정한다. 폼의 name속성과 
	1:1로 매칭되는 DTO의 속성(멤버변수)들이 있기 때문에 이와 같은 작업이 가능하게 된다. 
