...
<%--
	...
	설정한 페이지에서 하겠다는 선언이다. 
	500 에러와 같은 페이지를 사용자에게 보여주지 않아도 되므로 사이트에 대한 
	신뢰도를 높일 수 있다.  
...
String errorStr = "";
/*
해당 페이지로 폼값을 전송할 때 "나이" 부분은 공백 상태 혹은 영문자를 전송하면 
아래 코드에서 에러가 발생된다. Integer.parseInt()의 인자로 숫자가 
아닌 문자열이 전달되면 NumberFormatException이 발생된다. 
*/
if(strAge != null){
