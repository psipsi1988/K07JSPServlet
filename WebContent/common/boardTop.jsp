			...
			<nav class="navbar navbar-expand-sm bg-light navbar-dark">
				...
				<% if(session.getAttribute("USER_ID")==null){ %>
					...
					<li class="nav-item"> <!-- 로그인 -->
						<a class="nav-link text-dark" href="..//06Session/Login.jsp"><i class='fa fa-cogs' style='font-size:20px'></i>회원정보수정</a>
					</li> 
				<% } else { %>
					...
					<li class="nav-item"> <!-- 로그아웃 -->
						<a class="nav-link text-dark" href="..//06Session/Login.jsp"><i class='fas fa-sign-out-alt' style='font-size:20px'></i>로그아웃</a>
					</li>
				<% } %>
				</ul>
			</nav>
