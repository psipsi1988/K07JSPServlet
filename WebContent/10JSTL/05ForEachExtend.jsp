...
<body>
	...
	<!-- JSP에서 생성한 배열을 JSTL에서 사용하기 위해 set태그로 변수 선언 -->
	...
	lists.add(new MemberDTO("Park", "1111", "박씨", null));
	lists.add(new MemberDTO("Sung", "1111", "성씨", null));
	%>
	...
	<%--
	루프 내에서 객체를 전달한 변수 map을 통해 맵의 Key값과 value값을 알아낼 수 있다. 
		키값 : ${맵의 이름.key}
		밸류값 : ${맵의 이름.value}
	  --%>
