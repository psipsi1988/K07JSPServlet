...
<body>
	...
	out태그에 value속성의 값이 null일 때는 default속성에 
		지정한 값이 출력된다. 
	단, 값이 빈문자열("")인 경우는 값이 있는 것으로 간주되어 
	...
	<!-- 
		...
		있는 경우에는 해당 파라미터값을 가져와서 페이지를 설정한다. 
	 -->
	<h3>페이지 링크에 응용하기</h3>
	<c:url value="/08Board2/BoardList.jsp?nowPage="/><c:out value="${null }" default="1"/>
	<hr />
	<!-- 주의] 한 줄로 붙여서 작성하세요 줄바꿈하면 공백이 들어갑니다.  -->
	<a href="<c:url value="/08Board2/BoardList.jsp?nowPage="/><c:out value="${param.nowPage }" default="1"/>">회원제 게시판 리스트 바로가기</a>
</body>
</html>
