...
<body>
	...
	- EL에서 오류가 났을 때 에러 처리를 위해 사용된다. 
	- 에러 내용을 원하는 위치에 출력할 때 사용한다. 
	- JSTL문법오류는 catch되지 않는다. EL에서만 사용 가능하다.  
	 -->
	<h2>catch 태그</h2>
	...
	<h3>에러가 안 나는 경우 : 에러 내용이 저장 안 됨</h3>
	<!-- 
	아래의 경우는 0으로 나눠서 계산식 자체에는 문제가 있지만 
	에러가 발생하지 않기 때문에 변수에 에러 내용이 저장되지 않는다. 
	페이지 오류 없이  infinity로 출력된다.  
	 -->	
