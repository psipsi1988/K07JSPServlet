...
<body>
	...
	<!-- 
		요청명을 결정할 때는 View의 경로와 동일한 Depth(깊이)로 설정하는 것이 좋다. 
		이미지의 경로 JS, CSS파일을 링크했을 때 경로가 깨지는 경우가 발생할 수 있기 때문이다. 
		아래 이미지는 요청명이 
			"/13Servlet/SimpleMVC"일 때는 정상적으로 출력되나
			"/SimpleMVC"일 때는 이미지가 출력되지 않는다. 
	 -->
