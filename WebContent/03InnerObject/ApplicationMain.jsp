...
<body>
	...
	<%--
	웹애플리케이션(컨텍스트)을 구성하는 모든 JSP(Servlet)에서 
	...
	<%--
	ServletContext의 메소드인 getRealPath()로 서버의 물리적 경로를 얻어올 수 있다. 
	사용시 context root를 제외한 /로 시작하는 절대경로를 입력해야 한다. 
	 --%>
	...
	<%--
	선언부어서 JSP의 내장객체를 사용할 때 해당 내장객체의 클래스타입으로 
	사용해야 한다. application객체는 ServletContext타입을 가지고 있다. 
	 --%>
