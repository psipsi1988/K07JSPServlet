...
<%
//세션 영역에 저장된 아이디 속성이 없다면 로그인폼을 출력한다. 
if(session.getAttribute("USER_ID")==null){
%>
	<form action="CookieLoginProc.jsp" method="post">
	<!-- 
		input태그의 tabindex속성
		: 포커스 이동을 위해 탭(Tab)키를 눌렀을 때 포커스가 이동하는  순서를 지정한다. 
		 지정되지 않으면 input태그가 작성된 순서대로 이동하게 된다. 
	 -->
	<table border="1">
		<tr>
			<td>아이디</td>
			<td>
				...
				<!-- 변수 user에 저장된 값이 있을 때 checkbox의 checked속성을 활성화한다.  -->
